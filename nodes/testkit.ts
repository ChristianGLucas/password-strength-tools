// Shared test context for password-strength-tools node unit tests. Not a
// node and not a test file (no describe/it), so it is neither registered as
// a node nor collected by jest.
import {
  AxiomContext,
  AxiomLogger,
  AxiomSecrets,
